...
const Sidebar = () => {
  return (
    <>
      ...
      <section className=" min-h-screen h-full flex flex-col gap-4 items-start fixed lg:relative top-0 left-0 lg:left-auto z-40 transition-transform transform -translate-x-full lg:translate-x-0 peer-checked:translate-x-0">
